   ...
   public void curtirMusica() throws SQLException {
    ...
    try {
        ...
        if (musicasEncontradas != null && !musicasEncontradas.isEmpty() && indiceAtualmus >= 0 && indiceAtualmus < musicasEncontradas.size()) {
            ...
            if (statusCurtida == null || statusCurtida == false) { 
                try {
                    ...
                    if (statusCurtida != null && statusCurtida == false) {
                        novasDescurtidas = Math.max(0, MusicaAtual.getDescurtidas() - 1); 
                    }
                    ...
                    MusicaAtual.setDescurtidas(novasDescurtidas); 
                    exibirMusicaAtual();
...
public void descurtirMusica() throws SQLException {
    ...
    try {
        ...
        if (musicasEncontradas != null && !musicasEncontradas.isEmpty() && indiceAtualmus >= 0 && indiceAtualmus < musicasEncontradas.size()) {
            ...
            if (statusCurtida == null || statusCurtida == true) { 
                try {
                    ...
                    if (statusCurtida != null && statusCurtida == true) { 
                        novasCurtidas = Math.max(0, MusicaAtual.getCurtidas() - 1); 
                    }
                    ...
                    MusicaAtual.setCurtidas(novasCurtidas); 
